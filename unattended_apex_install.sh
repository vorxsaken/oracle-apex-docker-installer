...
# Get APEX
curl -o apex-latest.zip https://download.oracle.com/otn_software/apex/apex_24.2_en.zip
...
ALTER USER APEX_PUBLIC_USER IDENTIFIED BY admin123;
EXIT;
EOF
...
BEGIN
    ...
    APEX_UTIL.create_user(
        p_user_name       => 'ADMIN',
        p_email_address   => 'mohammad.basyarudin@kcsi-id.com',
        p_web_password    => 'Tohnga123$',
...
dnf install ords-26.2.3-3.el8 -y
EOF
